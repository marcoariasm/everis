...
export const ModalitiesCards = ({ totalBalance }) => {
	...
	return (
		<>
			{totalBalance && (
				<ContentGrid>
					<Card optionCheck={false} title='95.5%' options={false} image={Arrow} type='normal'>
						<ContentCard
							value={getSimulation955('deliveryAmount')}
							totalBalance={totalBalance['mount95']}
					...
					<Card optionCheck={false} title='4.5%' options={false} image={Arrow} type='normal'>
						<ContentCard
							value={getSimulation45('deliveryAmount')}
							totalBalance={totalBalance['mount4.5']}
							title={textAlternatives.titleCardThree}
						/>
					</Card>
				</ContentGrid>
			)}
