			...
			<ContentGrid>
				...
				<GridTable>
					<GridRowTable>
						...
						<PensionAmount>
							<span className='statementTableBody'>{getSimulation('scheduledWithdrawal')}</span>
						</PensionAmount>
					</GridRowTable>
					<GridRowTable>
						<TitleContent>
						...
						<PensionAmount>
							<span className='statementTableBody'>{getSimulation('familyLifeAnnuity')}</span>
						</PensionAmount>
					</GridRowTable>
					<GridRowTable>
						<TitleContent>
						...
						<ContentPensionGroup>
							<ContentPension>
								...
								<PensionAmount>
									<span className='statementTableBody'>{getSimulation('temporaryRent')}</span>
								</PensionAmount>
							</ContentPension>
							<ContentPension>
								<PensionText>
								...
								<PensionAmount>
									<span className='statementTableBody'>{getSimulation('deferredLifeAnnuity')}</span>
								</PensionAmount>
							</ContentPension>
						</ContentPensionGroup>
					</GridRowTable>
