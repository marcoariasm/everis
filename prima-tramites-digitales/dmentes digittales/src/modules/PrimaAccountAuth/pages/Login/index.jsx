...
import { validatedDocumentTypeLogin, validateTextLogin } from 'modules/shared/helpers/HelperForm';
...
const Login = () => {
	...
	const checkDocumentTypeLength = (type) => validatedDocumentTypeLogin(type);
