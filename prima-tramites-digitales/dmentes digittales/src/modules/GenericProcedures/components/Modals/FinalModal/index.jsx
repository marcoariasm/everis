...
const loginConfirmationModal = {
  ...
  description2: 'El plazo de respuesta es de hasta 10 días útiles.',
    ...
    <Modal hidden={true} show={showModal} onClose={onClose}>
      <ModalContent>
        ...
        <ModalDescription>{loginConfirmationModal.description2}</ModalDescription><br/><br/>
          ...
          <ModalHighlitedDescription>{data.email? data.email:''}</ModalHighlitedDescription><br/>
          <ModalDescription>{loginConfirmationModal.message2}</ModalDescription>
          <ModalHighlitedDescription>{data.cellphone? data.cellphone:''}</ModalHighlitedDescription>
        <ModalNotification>
          <ModalDescription>{loginConfirmationModal.message3}</ModalDescription>
          <ModalHighlitedDescription2>{data.code?data.code:''}</ModalHighlitedDescription2>
        </ModalNotification>
