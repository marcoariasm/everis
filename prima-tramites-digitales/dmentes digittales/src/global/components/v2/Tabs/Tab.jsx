import "global/components/v2/Tabs/style.sass";
...
const ContentImageCard = styled.div`
  ...
  @media only screen and (max-width: ${size.tablet}) {
    ...
    justify-self: left;
    height: 100%;
    &.tab-list-item-v2>div:first-child{
...
class Tab extends Component {
  ...
  render() {
    ...
    let className = "tab-list-item-v2";

    if (activeTab === label) {
      className += " tab-list-active-v2";
    }
    ...
    return (
      <Link onClick={onClick} to="#">
        <ContentImageCard className={className}>
          <ImageData>
            <ReactSVG src={src} alt="New Application 2" />
          </ImageData>
