...
import GridAdviceInformation from 'pages/HomeAdvice/components/MainSection/GridAdviceInformation'
import ContentUsername from 'pages/HomeAdvice/components/TitleSection/ContentUsername'
import ContentButton from 'pages/HomeAdvice/components/FooterSection/ContentButton'
import CardInformationGray from 'pages/HomeAdvice/components/MainSection/CardInformationGray'
  ...
  const getMainContent = () => (
    <>
      ...
      <WhiteCard>
        ...
        />
        <CardInformationGray title="" text={`${formatter.format(totalBalance.totalAmount)}`} />
