    ...
    switch (classButton) {
      case "btn-sgt-icono":
        return css`
          ...
          border: none;
          cursor: pointer;
          border: 0.790233px solid #FF4F00;
...
`;
const ButtonIcon = ({ classButton, children, onClick, disabled = false }) => {
  return (
    <>
      {classButton === "btn-sgt-icono" && (
        <StyledButtonIcon classButton={classButton} onClick={onClick} disabled={disabled}>
