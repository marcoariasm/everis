...
// https://sv443.net/jokeapi/v2/joke/Any?lang=es
const endpointJokes = "https://sv443.net/jokeapi/v2/joke/Any";
...
const getJokes = async () => {
    try {
        let joke = '';
        const response = await fetch(endpointJokes);
        ...
        VoiceRSS.speech({
            key: '5d3500e1e22944dd8bedee21ca834c74',
            src: jokeString,
            hl: 'en-us',
            v: 'Linda',
            r: 0, 
